    ...
    <form>
        ...
        <div class="flex flex-col gap-5">
            <div>
                ...
                <input type="text" v-model="addName" class="  w-full py-1 px-2 mb-1  border border-green-900 rounded"
                    required>
            ...
            <div>
                <label>Email</label>
                <input type="email" v-model="addEmail" @input="Email"
            ...
            <div>
                ...
                <input type="text" v-model="addUsername"
                    class="block  w-full py-1 px-2 mb-1 text-base  border border-green-900 rounded" required>
            </div>
            <div>
                <label>Phone</label>
                <div class="flex">
        ...
        <div class="flex justify-center gap-4 mt-2">
            ...
            <button class=" text-center  py-1 px-3  bg-green-500 text-white hover:green-600" @click="add">Add
            </button>
        </div>
    </form>
</template>
